# <span style="color:hsl(289,80%,58%)">Learning Polymorphic REST APIs</span>
...
## <span style="color:hsl(67,80%,50%)">Table of contents</span>
...
## <span style="color:hsl(204,80%,58%)">1. 💡 The problem</span>
...
## <span style="color:hsl(119,80%,58%)">3. 🏗️ Design chosen for this repo</span>
...
## <span style="color:hsl(309,80%,58%)">7. 🏗️ Module layout</span>
...
## <span style="color:hsl(87,80%,58%)">8. 🧪 Running & testing</span>
...
## <span style="color:hsl(224,80%,58%)">9. 📚 Further reading</span>
